...
# Part 3— Designing a Mascot/Logo: A Fresh Start
...
As with previous AI posts, I'll include some of the prompts used in quotes.

> **TL;DR**: I realized that I just wanted the balloon while keeping the suit. And that I had to question what I really wanted instead of prompting until I hit gold. Feasible if you don't pay for credits and use the free tier for Nanobana Pro. Otherwise, think a little, make some sketches or something.

> The result was a logo recognizable to old subs but simplified and more catchy.
...
I had a random logo that I generated for Medium amidst all of this: a smiley balloon with a red cross on the face. It was for the "cancellable" aspect of it rather than "no happiness," though at this point I don't think it's that different.

Since that version of me is dead, it was odd doing more things with the old logo. I wanted something different.

I wanted to keep the new logo, so I tried a few things.
...
That will be its own post. The takeaway from this is that I finally used the mascot character (Chibi Ver.) for the YouTube logos, multiple colors and ordered as Power Rangers.

## First Interation: Shooting in the Dark
...
Even tried the male version for the funzies. Not sharing because it's mid.
...
## Second Iteration: Trying to Enhance the Current Logo
...
So to avoid that stupid problem, I:

1. Locally removed the background with the Image Preview from macOS.

2. Upscaled it with [Upscale Media](https://www.upscale.media/es).

3. Shared it to my phone.

4. Opened Lightroom, adjusted colors, removed the thingy from the circle.

5. Shared it back to my computer.

6. Edited it on Canva to add the background.

And finally it was ready to share on social media. And since it was Friday, with this, it's more than enough.

---

## Results

Quite happy with the result. I'm really not there, since my sub accounts have the content, but the old me is there. It kinda works both in a spiritual and organizational way.

I believe that, and that makes me happy.

---

## What's Next

If there's something to take from this, it's that prompting until you hit gold is inefficient. Stopping to ask yourself "what do I actually want?" saves time. And if you're not on a free tier burning through credits, maybe sketch something first.

That said, editing skills and knowing the right tools go a long way. The AI got me 80% there, but Canva, Lightroom, and macOS Image Preview handled the rest.

You don't need to be a designer, but knowing how to remove a background or adjust colors makes a difference.

Next post (maybe not from this series) will be about organization. Keeping your online presence consistent requires planning, and things scale fast. Especially when you're juggling multiple accounts and activities. But that will be for another time.
